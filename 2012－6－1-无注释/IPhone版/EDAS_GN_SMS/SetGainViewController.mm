...
- (void)viewDidLoad
{
	...
	radioV2_5 =[[ UICheckButton alloc ] initWithFrame : CGRectMake ( 35 , 80 , 200 , 32 )];
	...
	radioV5 =[[ UICheckButton alloc ] initWithFrame : CGRectMake ( 200 , 80 , 200 , 32 )];
	...
	radioV10 =[[ UICheckButton alloc ] initWithFrame : CGRectMake ( 35 , 120 , 200 , 32 )];
	...
	radioV20 =[[ UICheckButton alloc ] initWithFrame : CGRectMake ( 200 , 120 , 200 , 32 )];
	...
	comboSens= [[ UIComboBox alloc ] initWithFrame : CGRectMake ( 130 , 34 , 170 , 30 )];
