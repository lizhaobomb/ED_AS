...
- (void)viewDidLoad
{
	...
	*/
	...
	//-------------------------------------------- 
	UILabel *labSens5 = [[UILabel alloc] initWithFrame : CGRectMake ( 20 , 200 , 180 , 30 )];
	labSens5.text = @"埋深（米）：";
	[scrollView addSubview:labSens5];[labSens5 release];
	txtDepth = [[UITextField alloc] initWithFrame:CGRectMake(150, 200, 200, 30)];
	...
	//-------------------------------------------- 
	UILabel *labSens6 = [[UILabel alloc] initWithFrame : CGRectMake ( 20 , 230 , 180 , 30 )];
	labSens6.text = @"基岩：";
	[scrollView addSubview:labSens6];[labSens6 release];
	txtRock = [[UITextField alloc] initWithFrame:CGRectMake(150, 230, 200, 30)];
	...
	//-------------------------------------------- 
	UILabel *labSens7 = [[UILabel alloc] initWithFrame : CGRectMake ( 20 , 260 , 180 , 30 )];
	labSens7.text = @"序列号：";
	[scrollView addSubview:labSens7];[labSens7 release];

	txtSerial = [[UITextField alloc] initWithFrame:CGRectMake(150, 260, 200, 30)];
