...
- (void)viewDidLoad
{
	...
	checkBack =[[ UICheckButton alloc ] initWithFrame : CGRectMake ( 30 , 60 , 170 , 30 )];
	...
	checkBinit =[[ UICheckButton alloc ] initWithFrame : CGRectMake ( 200 , 60 , 250 , 30 )];
	...
	checkBebroad =[[ UICheckButton alloc ] initWithFrame : CGRectMake ( 30 , 90 , 170 , 30 )];
	...
	checkBestat =[[ UICheckButton alloc ] initWithFrame : CGRectMake ( 200 , 90 , 250 , 30 )];
