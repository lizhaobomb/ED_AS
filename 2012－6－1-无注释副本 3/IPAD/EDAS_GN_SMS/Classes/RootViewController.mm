...
-(void) DisplayData
{
	...
	/*
	 ...
	 while(pchn!=NULL)
	 {
	 rg.origin.y=l*self.u_drawview.m_rectangle.size.height/self.u_drawview.m_dspctl.channelnum;
	 rg.size.height=(l+1)*self.u_drawview.m_rectangle.size.height/self.u_drawview.m_dspctl.channelnum+1-rg.origin.y;
	 if(cn==0){
	 step=0;
	 ...
	 posi++;
	 if(posi>=self.u_drawview.m_dspctl.scantime)
	 posi=0;
	 }
