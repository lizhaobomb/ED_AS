...
- (void)viewDidLoad
{
	...
	cmboChannel = [[ UIComboBox alloc ] initWithFrame : CGRectMake ( 173 + xW , 20+yH , 180 , 28 )];
	...
	checkSameAll =[[ UICheckButton alloc ] initWithFrame : CGRectMake ( 140 + xW , 170+yH , 170 , 30 )];
