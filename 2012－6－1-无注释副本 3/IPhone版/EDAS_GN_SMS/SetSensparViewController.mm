...
- (void)viewDidLoad
{
	...
	/*
	UILabel *labSens = [[UILabel alloc] initWithFrame : CGRectMake ( 20 , 20 , 180 , 30 )];
	labSens.text = @"选择地震计：";
	[scrollView addSubview:labSens];[labSens release];
	
	
	cmboSens = [[ UIComboBox alloc ] initWithFrame : CGRectMake ( 150 , 20 , 200 , 28 )];
	cmboSens.dropMaxHeigth  = 32*4;
	NSArray *cmboSensData = [[NSArray alloc] initWithObjects:@"A 地震计",@"B 地震计",@"C 地震计",@"D 地震计", nil];
	//cmboSens.itemViewCornerRadius = 0.2f;
	[cmboSens setItems:cmboSensData];
	cmboSens.delegate = self;
	[cmboSensData release];
	...
	*/
	...
	/*
	//-------------------------------------------- 
	UILabel *labSens1 = [[UILabel alloc] initWithFrame : CGRectMake ( 20 , 50 , 180 , 30 )];
	labSens1.text = @"地震计型号：";
	[scrollView addSubview:labSens1];[labSens1 release];
		
	cmboSensName = [[ UIComboBox alloc ] initWithFrame : CGRectMake ( 150 , 50 , 200 , 28 )];
	...
	//-------------------------------------------- 
	UILabel *labSens1_1 = [[UILabel alloc] initWithFrame : CGRectMake ( 20 , 80 , 180 , 30 )];
	labSens1_1.text = @"地震计名：";
	[scrollView addSubview:labSens1_1];[labSens1_1 release];
	
	txtSensName = [[UITextField alloc] initWithFrame:CGRectMake(150, 80, 200, 30)];
	txtSensName.borderStyle =  UITextBorderStyleRoundedRect;
	txtSensName.delegate =self;
	[scrollView addSubview:txtSensName];	
	 
	//-------------------------------------------- 
	 UILabel *labSens2 = [[UILabel alloc] initWithFrame : CGRectMake ( 20 , 110 , 180 , 30 )];
	labSens2.text = @"带宽：";
	[scrollView addSubview:labSens2];[labSens2 release];
	
	txtBand = [[UITextField alloc] initWithFrame:CGRectMake(150, 110, 200, 30)];
	txtBand.borderStyle =  UITextBorderStyleRoundedRect;
	txtBand.delegate =self;
	[scrollView addSubview:txtBand];
	
	 //-------------------------------------------- 
	 UILabel *labSens3 = [[UILabel alloc] initWithFrame : CGRectMake ( 20 , 140 , 180 , 30 )];
	labSens3.text = @"标准类型：";
	[scrollView addSubview:labSens3];[labSens3 release];
	
	cmboType = [[ UIComboBox alloc ] initWithFrame : CGRectMake ( 150 , 142 , 200 , 28 )];
	...
	[cmboType release];
	  ...
	  //-------------------------------------------- 
	 UILabel *labSens4 = [[UILabel alloc] initWithFrame : CGRectMake ( 20 , 170 , 180 , 30 )];
	labSens4.text = @"记录类型：";
	...
	cmboRecType = [[ UIComboBox alloc ] initWithFrame : CGRectMake ( 150 , 172 , 200 , 28 )];
	//cmboSensName.dropMaxHeigth  = 32*4;
	 ...
	 */
    //--------------------------------------------
	UILabel *labSens1 = [[UILabel alloc] initWithFrame : CGRectMake ( 20 , 20 , 180 , 30 )];
	labSens1.text = @"方位角：";
	[scrollView addSubview:labSens1];[labSens1 release];
	txtAzim = [[UITextField alloc] initWithFrame:CGRectMake(150, 20, 200, 30)];
	txtAzim.borderStyle =  UITextBorderStyleRoundedRect;
	txtAzim.delegate =self;
	[scrollView addSubview:txtAzim];
    
	//-------------------------------------------- 
	UILabel *labSens5 = [[UILabel alloc] initWithFrame : CGRectMake ( 20 , 50 , 180 , 30 )];
	labSens5.text = @"埋深（米）：";
	[scrollView addSubview:labSens5];[labSens5 release];
	txtDepth = [[UITextField alloc] initWithFrame:CGRectMake(150, 50, 200, 30)];
	...
	//-------------------------------------------- 
	UILabel *labSens6 = [[UILabel alloc] initWithFrame : CGRectMake ( 20 , 80 , 180 , 30 )];
	labSens6.text = @"基岩：";
	[scrollView addSubview:labSens6];[labSens6 release];
	txtRock = [[UITextField alloc] initWithFrame:CGRectMake(150, 80, 200, 30)];
	...
	//-------------------------------------------- 
	UILabel *labSens7 = [[UILabel alloc] initWithFrame : CGRectMake ( 20 , 110 , 180 , 30 )];
	labSens7.text = @"序列号：";
	[scrollView addSubview:labSens7];[labSens7 release];

	txtSerial = [[UITextField alloc] initWithFrame:CGRectMake(150, 110, 200, 30)];
	...
	//-------------------------------------------- 
	/*
	UILabel *labSens8 = [[UILabel alloc] initWithFrame : CGRectMake ( 20 , 290 , 180 , 30 )];
	labSens8.text = @"供应商：";
	[scrollView addSubview:labSens8];[labSens8 release];
	
	txtProvider = [[UITextField alloc] initWithFrame:CGRectMake(150, 290, 200, 30)];
	...
	UILabel *labSens9 = [[UILabel alloc] initWithFrame : CGRectMake ( 20 , 320 , 180 , 30 )];
	labSens9.text = @"分向信息";
	[scrollView addSubview:labSens9];[labSens9 release];
	
	UILabel *labSens10 = [[UILabel alloc] initWithFrame : CGRectMake ( 20 , 350 , 180 , 30 )];
	labSens10.text = @"分向数：";
	[scrollView addSubview:labSens10];[labSens10 release];
	
	
	txtComp = [[UITextField alloc] initWithFrame:CGRectMake(150, 350, 200, 30)];
	...
	//-------------------------------------------- 
	UILabel *labSens11 = [[UILabel alloc] initWithFrame : CGRectMake ( 20 , 380 , 180 , 30 )];
	labSens11.text = @"起始通道：";
	...
	*/
	 ...
	 */
	/*
	cmboChn1AD = [[ UIComboBox alloc ] initWithFrame : CGRectMake ( 150 , 380 , 200 , 28 )];
	...
	//-------------------------------------------- 
	UILabel *labSens12 = [[UILabel alloc] initWithFrame : CGRectMake ( 20 , 410 , 180 , 30 )];
	labSens12.text = @"分向 1 测项分量代码：";
	[scrollView addSubview:labSens12];[labSens12 release];
	
	cmboChn1cxid = [[ UIComboBox alloc ] initWithFrame : CGRectMake ( 205 , 410 , 170 , 28 )];
	[scrollView addSubview:cmboChn1cxid];[cmboChn1cxid release];
	
	//-------------------------------------------- 
	UILabel *labSens13 = [[UILabel alloc] initWithFrame : CGRectMake ( 20 , 440 , 190 , 30 )];
	labSens13.text = @"分向 2 测项分量代码：";
	[scrollView addSubview:labSens13];[labSens13 release];
	
	cmboChn2cxid = [[ UIComboBox alloc ] initWithFrame : CGRectMake ( 205 , 440 , 170 , 28 )];
	[scrollView addSubview:cmboChn2cxid];[cmboChn2cxid release];

	//-------------------------------------------- 
	UILabel *labSens14 = [[UILabel alloc] initWithFrame : CGRectMake ( 20 , 470 , 180 , 30 )];
	labSens14.text = @"分向 3 测项分量代码：";
	[scrollView addSubview:labSens14];[labSens14 release];
	cmboChn3cxid = [[ UIComboBox alloc ] initWithFrame : CGRectMake ( 205 , 470 , 170 , 28 )];
...
- (void) InitC:(NSInteger) index
{
	...
	*/
    ...
    //txtAzim.text = [[NSString alloc] initWithUTF8String:siteDoc.m_das.sens[selCmboSens].sens_par.];
	sprintf(temp,"%ld",siteDoc.m_das.sens[m_sensid].sens_par.depth);
	...
	txtBand.text= [[NSString alloc] initWithUTF8String:siteDoc.m_das.sens[selCmboSens].sens_par.bandstr]; 
	sprintf(temp, "%ld", siteDoc.m_das.sens[selCmboSens].sens_par.comp); 
	txtComp.text = [[NSString alloc] initWithUTF8String:temp];
...
//		return;
    if (txtSerial.text.length == 0||txtAzim.text.length == 0) {
        return;
    }
...
//	if(intcomp <1 || intcomp > 3) {return;}
	...
	NSString *senName = @"EDAS-AS";
    NSString *provider = @"GEOLIGHT";
    NSString *bandStr = @"80Hz";
	sprintf(frm.name,"%s",[senName UTF8String]);
	sprintf(frm.provider,"%s",[provider UTF8String]);
	sprintf(frm.series,"%s",[txtSerial.text	UTF8String]);
	sprintf(frm.bandstr,"%s",[bandStr UTF8String]);
	sprintf(frm.rock,"%s",[txtRock.text UTF8String]);
    frm.azim=[txtAzim.text floatValue];
	frm.comp=intcomp;
	frm.das_id[0]=1;
	frm.das_id[1]=2;
	frm.das_id[2]=3;
...
//	theApp.GetCXSID([cmboType getSelectIndex],[[cmboChn3cxid.items objectAtIndex:[cmboChn3cxid getSelectIndex]] UTF8String], s);
	...
	{	//SendErr();
		...
		UIAlertView *av = [[[UIAlertView alloc] initWithTitle:@"提示" message:@"设置加速度计参数成功"
													 delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil] autorelease];
		[av show];	
	}
