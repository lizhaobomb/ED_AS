...
- (void)viewDidLoad
{
	...
	radio9600 =[[ UICheckButton alloc ] initWithFrame : CGRectMake ( 30 , 60 , 150 , 30 )];
	...
	radio19200 =[[ UICheckButton alloc ] initWithFrame : CGRectMake ( 180 , 60 , 150 , 30 )];
	...
	radio38400 =[[ UICheckButton alloc ] initWithFrame : CGRectMake ( 30 , 90 , 150 , 32 )];
	...
	radio57600 =[[ UICheckButton alloc ] initWithFrame : CGRectMake ( 180 , 90 , 150 , 32 )];
	...
	radio115200 =[[ UICheckButton alloc ] initWithFrame : CGRectMake ( 30 , 120 , 150 , 32 )];
